...
videojs.plugin('resolutions', function(options) {
  ...
  this.resolutions_ = {
    ...
    selectSource: function(sources){
      ...
      //console.log("selectSource",this.options_['sourceResolutions'])
  ...
  player.changeResolution = function(new_source){
   ...
   // console.log("changeResolution",new_source)
  ...
  //var s = player.options_['sources'];
 // var s = player.pl.videos;
 // var vid = player.pl.videos[player.pl.current];
 // console.log("s",s)
// console.log("sources",player.options_['sources'])
